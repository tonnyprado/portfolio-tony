/* Bilingual content + project data — window.PORT */
window.PORT = {
  ui: {
    nav: {
    ...
    hero: {
      ...
      desc: {
        es: "5+ años construyendo microservicios enterprise y plataformas SaaS en producción. Convierto problemas complejos en soluciones elegantes y escalables.",
        en: "5+ years building enterprise microservices and production SaaS platforms. Turning complex problems into elegant, scalable solutions.",
      },
      checks: {
        es: ["Del backend al pixel: end-to-end", "Microservicios, cloud e IA aplicada", "De idea a MVP en producción"],
        en: ["From backend to pixel: end-to-end", "Microservices, cloud & applied AI", "From idea to production MVP"],
      },
    ...
    skills: {
      ...
      langList: { es: [["Inglés",""],["Español","Nativo"]], en: [["English",""],["Spanish","Native"]] },
    },
    education: {
  ...
  certs: [{ name: "AWS Certified Cloud Practitioner", issuer: "Amazon Web Services" }],
